...
public class MascotaController {
    ...
    @PutMapping("/{id}")
    public void mascotaModificar(@PathVariable String id,@RequestBody Mascota mascota){
        this.mascotaService.mascotaModificar(id, mascota);
    }


    @DeleteMapping("/{id}")
    public void mascotaEliminar(@PathVariable String id){
        this.mascotaService.mascotaEliminar(id);
    }
